...
import { openConnection, runTransQuery, closeTransaction } from '../globals/bdconfig';
...
export class AuthRepository {
  ...
  constructor(private userRepository: UserRepository, private jwtAuthService: JwtService){}
